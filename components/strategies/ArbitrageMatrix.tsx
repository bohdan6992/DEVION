...
const COL_LABELS: Record<string, string> = {
  ...
  intra_any_rate: "Any", intra_hard_rate: "Hard", intra_soft_rate: "Soft",
  post_any_rate: "Any", post_hard_rate: "Hard", post_soft_rate: "Soft",
};
...
function getRateColor(valStr: string) {
  ...
  if (v < 0.8) return "text-emerald-300 font-semibold drop-shadow-[0_0_8px_rgba(52,211,153,0.4)]";
